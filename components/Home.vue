  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://nuxtjs.org" target="_blank">
        <img src="https://nosana.io/img/Nosana_Logo_horizontal_color_white.svg" alt="Nosana">
      </a>
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome Istanbul Hacker House! 🔥🔥🔥🔥🔥
        </h2>
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          To learn more visit <a href="https://nosana.io" target="_blank">https://Nosana.io</a>
        </p>
      </div>
